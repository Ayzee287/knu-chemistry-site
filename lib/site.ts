...
//
// Why this exists: canonical URLs, hreflang, OpenGraph, the sitemap and robots
// all need ONE consistent absolute origin. Previously each call site defaulted
// to `http://localhost:3000`, so a missing env var leaked localhost into
// production metadata. Resolve it here, once.
//
...
/** Absolute origin of the site, no trailing slash. e.g. "https://chem.example.ua". */
