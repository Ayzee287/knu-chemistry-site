 ...
 * (official departmental and faculty sites) are supplementary authority cues —
 * they open in a new tab, carry safe rel attributes, and are marked with a
 * restrained ↗ glyph so the departure from the site is always visible.
 *
